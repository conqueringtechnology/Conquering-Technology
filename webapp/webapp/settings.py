...
SECRET_KEY = 'r$dk(zs@c=o1jc2nz5i0=#@lt(w&l^a+lz#bq6+^dxw&p4id6m'
...
### Settings To Add To Project ###
# Reference the Database section to update the path.
# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/4.1/howto/static-files/
STATICFILES_DIRS = [BASE_DIR / 'static']
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'
# STATIC_ROOT = '/home/miguelro/conqueringtechnology/webapp/static/'


# The media as images will be stored here.
MEDIA_ROOT = BASE_DIR / 'media'
MEDIA_URL = '/media/'
# STATIC_ROOT = '/home/miguelro/conqueringtechnology/webapp/media/'
